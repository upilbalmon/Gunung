...
local function createVirtualKeyboard()
	...
	MinimizeButton.Position = UDim2.new(1, -20, 0.1, 0)
	MinimizeButton.Text = "-"
	...
	CloseButton.Position = UDim2.new(01, 0, 0.1, -7)
	CloseButton.Text = "X"
	...
	wButton.Position = UDim2.new(0.5, 40, 0.2, 0)
	...
	aButton.Position = UDim2.new(0.2, 40, 0.5, 0)
	...
	sButton.Position = UDim2.new(0.5, 40, 0.8, -20)
	...
	dButton.Position = UDim2.new(0.8, 40, 0.5, 0)
	...
	eButton.Size = UDim2.new(0, 30, 0, 30)
	eButton.Position = UDim2.new(0.2, -35, 0.2, 0)
	eButton.Text = "E"
	eButton.TextSize = 14
	...
	qButton.Size = UDim2.new(0, 30, 0, 30)
	qButton.Position = UDim2.new(0.2, -35, 0.8, -20)
	qButton.Text = "Q"
	qButton.TextSize = 14
